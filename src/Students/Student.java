 ...
 * @author 120212265
 * <p>
 * Abstract class Student that includes the following hidden attributes: «get»
 * id(int) {readonly}, «get/set» name(String), «get/set» major(String), «get»
 * grade(double) {readonly}.
 */
public abstract class Student {
    ...
    public Student(int ID, String name, String major, Mark... marks) {
        this.ID = ID;
        this.name = name;
        this.major = major;
        this.marks = marks;
    ...
    /**
     * Every child class must implement this method in his own way, his own mark
     * percentages
     */
